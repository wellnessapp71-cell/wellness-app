...
const cards = [
  { title: "Physical", score: 75, icon: Activity, color: "text-[#34C759]", bg: "bg-[#34C759]/10", msg: "HR trend stable" },
  { title: "Mental", score: 60, icon: Brain, color: "text-[#007AFF]", bg: "bg-[#007AFF]/10", msg: "Stress slightly up" },
  { title: "Spiritual", score: 85, icon: Sparkles, color: "text-[#AF52DE]", bg: "bg-[#AF52DE]/10", msg: "Streak: 7 days" },
  { title: "Lifestyle", score: 90, icon: Moon, color: "text-[#FF9500]", bg: "bg-[#FF9500]/10", msg: "Great sleep avg" },
];
      ...
      <GlassCard className="p-6 relative h-[340px]">
        <ResponsiveContainer width="100%" height="100%">
          <RadarChart cx="50%" cy="50%" outerRadius="65%" data={data}>
            ...
            <Radar name="Alex" dataKey="A" stroke="#007AFF" strokeWidth={3} fill="#007AFF" fillOpacity={0.15} />
          </RadarChart>
        </ResponsiveContainer>
