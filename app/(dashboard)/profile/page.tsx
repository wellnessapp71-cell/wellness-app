...
import { Shield, Bell, Settings, Building, ChevronRight } from "lucide-react";
...
export default function ProfilePage() {
  ...
  return (
    <div className="flex flex-col gap-8 p-6 pt-12 pb-32">
      ...
      <section>
        ...
        <GlassCard className="flex flex-col overflow-hidden">
          {[
            ...
            <div
              key={item.label}
              onClick={() => item.isLink && router.push("/admin")}
      ...
      <button onClick={() => router.push("/")} className="mt-2 active:opacity-70 transition-opacity">
